...
namespace WinFormsGraphicsDevice
{
    ...
    public partial class MainForm : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            npcStats.lp = (int)numericUpDown5.Value;
            npcStats.lpmax = (int)numericUpDown6.Value;
            npcStats.mh = (int)numericUpDown12.Value;
            npcStats.mhmax = (int)numericUpDown11.Value;
            npcStats.ch = (int)numericUpDown10.Value;
            npcStats.chmax = (int)numericUpDown9.Value;
            npcStats.cbonus = (int)0;
            npcStats.mp = (int)numericUpDown12.Value;
            npcStats.mpmax = (int)numericUpDown11.Value;
            npcStats.force = (int)numericUpDown8.Value;
            npcStats.intelligence = (int)numericUpDown7.Value;
            npcStats.defense = (int)numericUpDown14.Value;
            npcStats.criticalrate = (int)numericUpDown13.Value;
            npcStats.speed = (float)numericUpDown15.Value;
            npcStats.strspeed = Shared.Converter.FloatToString(npcStats.speed);

            npc = new Shared.Gob();
            npc.stats = npcStats;
            npc.name = textBox1.Text;
            npc.commonName = textBox2.Text;
            npc.type = textBox5.Text;
            npc.script = textBox3.Text;
            npc.spr = textBox4.Text;
